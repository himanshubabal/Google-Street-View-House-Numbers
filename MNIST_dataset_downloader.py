...
train_labels_zip = maybe_download('train-labels-idx1-ubyte.gz')

test_images_zip = maybe_download('t10k-images-idx3-ubyte.gz')
test_labels_zip = maybe_download('t10k-labels-idx1-ubyte.gz')

print('MNIST Dataset Download Complete')
print('-------------------------------')

train_images_file = maybe_extract('train-images-idx3-ubyte.gz')
train_labels_file = maybe_extract('train-labels-idx1-ubyte.gz')

test_images_file = maybe_extract('t10k-images-idx3-ubyte.gz')
test_labels_file = maybe_extract('t10k-labels-idx1-ubyte.gz')
...
scipy.io.savemat('mnist_default_train_28x28.mat', train)
scipy.io.savemat('mnist_default_test_28x28.mat', test)
